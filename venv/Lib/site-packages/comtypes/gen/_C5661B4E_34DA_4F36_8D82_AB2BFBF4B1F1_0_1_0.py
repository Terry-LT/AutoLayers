...
IAcadObject._methods_ = [
    COMMETHOD(
        [dispid(1024), 'nonbrowsable', 'propget'],
        HRESULT,
        'Handle',
        (['out', 'retval'], POINTER(BSTR), 'Handle')
    ),
    COMMETHOD(
        [dispid(1025), 'nonbrowsable', 'propget'],
        HRESULT,
        'ObjectName',
    ...
    COMMETHOD(
        [dispid(1034), 'nonbrowsable', 'propget'],
        HRESULT,
        'OwnerID',
        (['out', 'retval'], POINTER(LONG_PTR), 'OwnerID')
    ),
    COMMETHOD(
        [dispid(1035), 'nonbrowsable', 'propget'],
        HRESULT,
        'Document',
...
IAcadEntity._methods_ = [
    ...
    COMMETHOD(
        [dispid(1284), 'nonbrowsable', 'propget'],
        HRESULT,
        'Visible',
        (['out', 'retval'], POINTER(VARIANT_BOOL), 'bVisible')
    ),
    COMMETHOD(
        [dispid(1284), 'nonbrowsable', 'propput'],
        HRESULT,
        'Visible',
    ...
    COMMETHOD(
        [dispid(1397), 'hidden', 'nonbrowsable', 'propget'],
        HRESULT,
        'EntityName',
        (['out', 'retval'], POINTER(BSTR), 'EntityName')
    ),
    COMMETHOD(
        [dispid(1398), 'hidden', 'nonbrowsable', 'propget'],
        HRESULT,
        'EntityType',
        (['out', 'retval'], POINTER(c_int), 'entType')
    ),
    COMMETHOD(
        [dispid(1280), 'hidden', 'propget'],
        HRESULT,
        'color',
        (['out', 'retval'], POINTER(ACAD_COLOR), 'color')
    ),
    COMMETHOD(
        [dispid(1280), 'hidden', 'propput'],
        HRESULT,
        'color',
        (['in'], ACAD_COLOR, 'color')
    ),
...
IAcadMLeader._methods_ = [
    ...
    COMMETHOD(
        [dispid(9), 'nonbrowsable', 'propget'],
        HRESULT,
        'ContentBlockName',
        (['out', 'retval'], POINTER(BSTR), 'BlockName')
    ),
    COMMETHOD(
        [dispid(9), 'nonbrowsable', 'propput'],
        HRESULT,
        'ContentBlockName',
        (['in'], BSTR, 'BlockName')
    ),
    ...
    COMMETHOD(
        [dispid(24), 'nonbrowsable', 'propget'],
        HRESULT,
        'ArrowheadBlock',
        (['out', 'retval'], POINTER(BSTR), 'BlockName')
    ),
    COMMETHOD(
        [dispid(24), 'nonbrowsable', 'propput'],
        HRESULT,
        'ArrowheadBlock',
        (['in'], BSTR, 'BlockName')
    ),
    ...
    COMMETHOD(
        [dispid(26), 'nonbrowsable', 'propget'],
        HRESULT,
        'LeaderCount',
    ...
    COMMETHOD(
        [dispid(34), 'nonbrowsable', 'propput'],
        HRESULT,
        'ContentType',
        (['in'], AcMLeaderContentType, 'Type')
    ),
    COMMETHOD(
        [dispid(34), 'nonbrowsable', 'propget'],
        HRESULT,
        'ContentType',
...
IAcad3DSolid._methods_ = [
    COMMETHOD(
        [dispid(1), 'nonbrowsable', 'propget'],
        HRESULT,
        'Centroid',
        (['out', 'retval'], POINTER(VARIANT), 'Centroid')
    ),
    COMMETHOD(
        [dispid(2), 'nonbrowsable', 'propget'],
        HRESULT,
        'MomentOfInertia',
        (['out', 'retval'], POINTER(VARIANT), 'momentInertia')
    ),
    COMMETHOD(
        [dispid(3), 'nonbrowsable', 'propget'],
        HRESULT,
        'PrincipalDirections',
    ...
    COMMETHOD(
        [dispid(5), 'nonbrowsable', 'propget'],
        HRESULT,
        'ProductOfInertia',
        (['out', 'retval'], POINTER(VARIANT), 'prodInertia')
    ),
    COMMETHOD(
        [dispid(6), 'nonbrowsable', 'propget'],
        HRESULT,
        'RadiiOfGyration',
        (['out', 'retval'], POINTER(VARIANT), 'radiiGyration')
    ),
    COMMETHOD(
        [dispid(7), 'nonbrowsable', 'propget'],
        HRESULT,
        'Volume',
...
IAcadRasterImage._methods_ = [
    ...
    COMMETHOD(
        [dispid(14), 'nonbrowsable', 'propget'],
        HRESULT,
        'Height',
        (['out', 'retval'], POINTER(c_double), 'pixelHeight')
    ),
    COMMETHOD(
        [dispid(15), 'nonbrowsable', 'propget'],
        HRESULT,
        'Width',
        (['out', 'retval'], POINTER(c_double), 'pixelWidth')
    ),
    COMMETHOD(
        [dispid(16), 'nonbrowsable', 'propget'],
        HRESULT,
        'ShowRotation',
        (['out', 'retval'], POINTER(VARIANT_BOOL), 'bShow')
    ),
    COMMETHOD(
        [dispid(16), 'nonbrowsable', 'propput'],
        HRESULT,
        'ShowRotation',
...
IAcadPViewport._methods_ = [
    ...
    COMMETHOD(
        [dispid(13), 'nonbrowsable', 'propget'],
        HRESULT,
        'SnapBasePoint',
        (['out', 'retval'], POINTER(VARIANT), 'lowLeft')
    ),
    COMMETHOD(
        [dispid(13), 'nonbrowsable', 'propput'],
        HRESULT,
        'SnapBasePoint',
        (['in'], VARIANT, 'lowLeft')
    ),
    ...
    COMMETHOD(
        [dispid(14), 'nonbrowsable', 'propput'],
        HRESULT,
        'SnapOn',
    ...
    COMMETHOD(
        [dispid(15), 'nonbrowsable', 'propput'],
        HRESULT,
        'SnapRotationAngle',
        (['in'], c_double, 'Angle')
    ),
    ...
    COMMETHOD(
        [dispid(17), 'nonbrowsable', 'propget'],
        HRESULT,
        'UCSIconAtOrigin',
        (['out', 'retval'], POINTER(VARIANT_BOOL), 'bIconAtOrigin')
    ),
    COMMETHOD(
        [dispid(17), 'nonbrowsable', 'propput'],
        HRESULT,
        'UCSIconAtOrigin',
    ...
    COMMETHOD(
        [dispid(23), 'nonbrowsable', 'propget'],
        HRESULT,
        'TwistAngle',
        (['out', 'retval'], POINTER(ACAD_ANGLE), 'Angle')
    ),
    COMMETHOD(
        [dispid(23), 'nonbrowsable', 'propput'],
        HRESULT,
        'TwistAngle',
        (['in'], ACAD_ANGLE, 'Angle')
    ),
    ...
    COMMETHOD(
        [dispid(25), 'hidden', 'propget'],
        HRESULT,
        'RemoveHiddenLines',
        (['out', 'retval'], POINTER(VARIANT_BOOL), 'bRemoval')
    ),
    COMMETHOD(
        [dispid(25), 'hidden', 'propput'],
        HRESULT,
        'RemoveHiddenLines',
    ...
    COMMETHOD(
        [dispid(26), 'nonbrowsable', 'propput'],
        HRESULT,
        'Target',
        (['in'], VARIANT, 'targetPoint')
    ),
    COMMETHOD(
        [dispid(27), 'nonbrowsable', 'propget'],
        HRESULT,
        'ArcSmoothness',
        (['out', 'retval'], POINTER(c_int), 'arcSmooth')
    ),
    COMMETHOD(
        [dispid(27), 'nonbrowsable', 'propput'],
        HRESULT,
        'ArcSmoothness',
        (['in'], c_int, 'arcSmooth')
    ),
...
IAcadTolerance._methods_ = [
    COMMETHOD(
        [dispid(80), 'nonbrowsable', 'propget'],
        HRESULT,
        'DirectionVector',
        (['out', 'retval'], POINTER(VARIANT), 'dirVector')
    ),
    COMMETHOD(
        [dispid(80), 'nonbrowsable', 'propput'],
        HRESULT,
        'DirectionVector',
        (['in'], VARIANT, 'dirVector')
    ),
    ...
    COMMETHOD(
        [dispid(82), 'nonbrowsable', 'propget'],
        HRESULT,
        'Normal',
        (['out', 'retval'], POINTER(VARIANT), 'Normal')
    ),
    COMMETHOD(
        [dispid(82), 'nonbrowsable', 'propput'],
        HRESULT,
        'Normal',
        (['in'], VARIANT, 'Normal')
    ),
...
IAcadText._methods_ = [
    ...
    COMMETHOD(
        [dispid(12), 'nonbrowsable', 'propget'],
        HRESULT,
        'Normal',
        (['out', 'retval'], POINTER(VARIANT), 'Normal')
    ),
    COMMETHOD(
        [dispid(12), 'nonbrowsable', 'propput'],
        HRESULT,
        'Normal',
        (['in'], VARIANT, 'Normal')
    ),
...
IAcadLeader._methods_ = [
    ...
    COMMETHOD(
        [dispid(1537), 'nonbrowsable', 'propget'],
        HRESULT,
        'Normal',
        (['out', 'retval'], POINTER(VARIANT), 'Normal')
    ),
    ...
    COMMETHOD(
        [dispid(68), 'nonbrowsable', 'propget'],
        HRESULT,
        'Annotation',
        (['out', 'retval'], POINTER(POINTER(IAcadEntity)), 'pVal')
    ),
    COMMETHOD(
        [dispid(68), 'nonbrowsable', 'propput'],
        HRESULT,
        'Annotation',
    ...
    COMMETHOD(
        [dispid(70), 'nonbrowsable', 'propget'],
        HRESULT,
        'ArrowheadBlock',
        (['out', 'retval'], POINTER(BSTR), 'BlockName')
    ),
    COMMETHOD(
        [dispid(70), 'nonbrowsable', 'propput'],
        HRESULT,
        'ArrowheadBlock',
        (['in'], BSTR, 'BlockName')
    ),
...
IAcadBlockReference._methods_ = [
    ...
    COMMETHOD(
        [dispid(11), 'nonbrowsable', 'propget'],
        HRESULT,
        'HasAttributes',
    ...
    COMMETHOD(
        [dispid(513), 'nonbrowsable', 'propget'],
        HRESULT,
        'IsDynamicBlock',
        (['out', 'retval'], POINTER(VARIANT_BOOL), 'pDynamicBlock')
    ),
...
IAcadPolygonMesh._methods_ = [
    ...
    COMMETHOD(
        [dispid(11), 'nonbrowsable', 'propput'],
        HRESULT,
        'Coordinate',
        (['in'], c_int, 'Index'),
        (['in'], VARIANT, 'pVal')
...
IAcadAttribute._methods_ = [
    ...
    COMMETHOD(
        [dispid(18), 'nonbrowsable', 'propget'],
        HRESULT,
        'Mode',
        (['out', 'retval'], POINTER(c_int), 'Mode')
    ),
    COMMETHOD(
        [dispid(18), 'nonbrowsable', 'propput'],
        HRESULT,
        'Mode',
        (['in'], c_int, 'Mode')
    ),
...
IAcadEllipse._methods_ = [
    ...
    COMMETHOD(
        [dispid(10), 'nonbrowsable', 'propget'],
        HRESULT,
        'EndParameter',
        (['out', 'retval'], POINTER(c_double), 'EndParameter')
    ),
    COMMETHOD(
        [dispid(10), 'nonbrowsable', 'propput'],
        HRESULT,
        'EndParameter',
...
IAcadDimension._methods_ = [
    ...
    COMMETHOD(
        [dispid(1537), 'nonbrowsable', 'propput'],
        HRESULT,
        'Normal',
        (['in'], VARIANT, 'Normal')
    ),
    COMMETHOD(
        [dispid(1538), 'nonbrowsable', 'propget'],
        HRESULT,
        'Rotation',
        (['out', 'retval'], POINTER(ACAD_ANGLE), 'rotAngle')
    ),
    COMMETHOD(
        [dispid(1538), 'nonbrowsable', 'propput'],
        HRESULT,
        'Rotation',
        (['in'], ACAD_ANGLE, 'rotAngle')
    ),
...
IAcadDimRadialLarge._methods_ = [
    ...
    COMMETHOD(
        [dispid(66), 'nonbrowsable', 'propget'],
        HRESULT,
        'ArrowheadBlock',
        (['out', 'retval'], POINTER(BSTR), 'BlockName')
    ),
    COMMETHOD(
        [dispid(66), 'nonbrowsable', 'propput'],
        HRESULT,
        'ArrowheadBlock',
        (['in'], BSTR, 'BlockName')
    ),
...
IAcadDimArcLength._methods_ = [
    ...
    COMMETHOD(
        [dispid(65), 'nonbrowsable', 'propget'],
        HRESULT,
        'Arrowhead1Block',
        (['out', 'retval'], POINTER(BSTR), 'BlockName')
    ),
    COMMETHOD(
        [dispid(65), 'nonbrowsable', 'propput'],
        HRESULT,
        'Arrowhead1Block',
        (['in'], BSTR, 'BlockName')
    ),
...
IAcadDim3PointAngular._methods_ = [
    COMMETHOD(
        [dispid(38), 'nonbrowsable', 'propget'],
        HRESULT,
        'ExtLine1EndPoint',
        (['out', 'retval'], POINTER(VARIANT), 'xLine1Point')
    ),
    COMMETHOD(
        [dispid(38), 'nonbrowsable', 'propput'],
        HRESULT,
        'ExtLine1EndPoint',
        (['in'], VARIANT, 'xLine1Point')
    ),
    COMMETHOD(
        [dispid(40), 'nonbrowsable', 'propget'],
        HRESULT,
        'ExtLine2EndPoint',
        (['out', 'retval'], POINTER(VARIANT), 'xLine2Point')
    ),
    COMMETHOD(
        [dispid(40), 'nonbrowsable', 'propput'],
        HRESULT,
        'ExtLine2EndPoint',
        (['in'], VARIANT, 'xLine2Point')
    ),
    COMMETHOD(
        [dispid(45), 'nonbrowsable', 'propget'],
        HRESULT,
        'AngleVertex',
        (['out', 'retval'], POINTER(VARIANT), 'AngleVertex')
    ),
    COMMETHOD(
        [dispid(45), 'nonbrowsable', 'propput'],
        HRESULT,
        'AngleVertex',
        (['in'], VARIANT, 'AngleVertex')
    ),
...
IAcadDimAngular._methods_ = [
    COMMETHOD(
        [dispid(37), 'nonbrowsable', 'propget'],
        HRESULT,
        'ExtLine1StartPoint',
        (['out', 'retval'], POINTER(VARIANT), 'xLine1Point')
    ),
    COMMETHOD(
        [dispid(37), 'nonbrowsable', 'propput'],
        HRESULT,
        'ExtLine1StartPoint',
        (['in'], VARIANT, 'xLine1Point')
    ),
    ...
    COMMETHOD(
        [dispid(39), 'nonbrowsable', 'propget'],
        HRESULT,
        'ExtLine2StartPoint',
        (['out', 'retval'], POINTER(VARIANT), 'xLine2Point')
    ),
    COMMETHOD(
        [dispid(39), 'nonbrowsable', 'propput'],
        HRESULT,
        'ExtLine2StartPoint',
        (['in'], VARIANT, 'xLine2Point')
    ),
...
IAcadDimDiametric._methods_ = [
    COMMETHOD(
        [dispid(42), 'nonbrowsable', 'propput'],
        HRESULT,
        'LeaderLength',
        (['in'], c_double, 'rhs')
    ),
...
IAcadTable._methods_ = [
    ...
    COMMETHOD(
        [dispid(65520), 'propget'],
        HRESULT,
        'BreaksEnabled',
        (['out', 'retval'], POINTER(VARIANT_BOOL), 'bEnabled')
    ),
    COMMETHOD(
        [dispid(65520), 'propput'],
        HRESULT,
        'BreaksEnabled',
        (['in'], VARIANT_BOOL, 'bEnabled')
    ),
    COMMETHOD(
        [dispid(65521), 'propget'],
        HRESULT,
        'RepeatTopLabels',
        (['out', 'retval'], POINTER(VARIANT_BOOL), 'bEnabled')
    ),
    COMMETHOD(
        [dispid(65521), 'propput'],
        HRESULT,
        'RepeatTopLabels',
        (['in'], VARIANT_BOOL, 'bEnabled')
    ),
    COMMETHOD(
        [dispid(65522), 'propget'],
        HRESULT,
        'RepeatBottomLabels',
        (['out', 'retval'], POINTER(VARIANT_BOOL), 'bEnabled')
    ),
    COMMETHOD(
        [dispid(65522), 'propput'],
        HRESULT,
        'RepeatBottomLabels',
        (['in'], VARIANT_BOOL, 'bEnabled')
    ),
    COMMETHOD(
        [dispid(65523), 'propget'],
        HRESULT,
        'TableBreakFlowDirection',
        (['out', 'retval'], POINTER(AcTableFlowDirection), 'pDir')
    ),
    COMMETHOD(
        [dispid(65523), 'propput'],
        HRESULT,
        'TableBreakFlowDirection',
        (['in'], AcTableFlowDirection, 'pDir')
    ),
    COMMETHOD(
        [dispid(65524), 'propget'],
        HRESULT,
        'AllowManualPositions',
        (['out', 'retval'], POINTER(VARIANT_BOOL), 'bEnabled')
    ),
    COMMETHOD(
        [dispid(65524), 'propput'],
        HRESULT,
        'AllowManualPositions',
        (['in'], VARIANT_BOOL, 'bEnabled')
    ),
    COMMETHOD(
        [dispid(65525), 'propget'],
        HRESULT,
        'AllowManualHeights',
        (['out', 'retval'], POINTER(VARIANT_BOOL), 'bEnabled')
    ),
    COMMETHOD(
        [dispid(65525), 'propput'],
        HRESULT,
        'AllowManualHeights',
        (['in'], VARIANT_BOOL, 'bEnabled')
    ),
    COMMETHOD(
        [dispid(65526), 'propget'],
        HRESULT,
        'TableBreakHeight',
        (['out', 'retval'], POINTER(c_double), 'pHeight')
    ),
    COMMETHOD(
        [dispid(65526), 'propput'],
        HRESULT,
        'TableBreakHeight',
        (['in'], c_double, 'pHeight')
    ),
    COMMETHOD(
        [dispid(65527), 'propget'],
        HRESULT,
        'BreakSpacing',
        (['out', 'retval'], POINTER(c_double), 'pSpacing')
    ),
    COMMETHOD(
        [dispid(65527), 'propput'],
        HRESULT,
        'BreakSpacing',
...
__all__ = [
    'ac1_2', 'IAcadSubEntSolidNode', 'acRotation', 'acRaster',
    'acPreferenceClassic', 'AcSelect', 'acMillimeters',
    'AcCellOption', 'acCellLeftGridColor', 'acLsLineType',
    'acOutside', 'acDimArchitecturalStacked',
    'acDataHorzBottomLineWeight', 'acDimDiametric', 'acMenuSeparator',
    'Ac3DPolylineType', 'acAttributeModeInvisible', 'AcLoadPalette',
    'AcadDimStyles', 'AcLeaderType', 'acLeftToRight', 'IAcadGroup',
    'acConnectExtents', 'ac2007_dxf', 'acTableFlowLeft',
    'AcSectionType', 'IAcadEllipse', 'IAxDbDocument', 'IAcadSpline',
    'acSectionStatePlane', 'acGridLineStyleDouble',
    'acInsertUnitsParsecs', 'AcadDimension', 'acGeneral', 'ac1_5',
    'acPreferenceCustom', 'AcadLoftedSurface', 'IAcadSubEntSolidFace',
    'AcExtendOption', 'acHatchLoopTypeTextbox', 'acInsertUnitsMils',
    'acHeaderRowAlignment', 'acUniform', 'AcDrawMLeaderOrderType',
    'acSelectionSetWindowPolygon', 'acAlignmentTopLeft',
    'acDataVertInsideLineWeight', 'acTolBottom',
    'acHeaderRowDataType', 'AcMergeCellStyleOption', 'ACAD_LAYER',
    'IAcadPlotConfigurations', 'acSectionGenerationSourceAllObjects',
    'acAlwaysRightReadingAngle', 'IAcadDictionary', 'ac2007_dwg',
    'acTitleRowFillNone', 'LONG_PTR', 'AcDimTextMovement',
    'acOQHighPhoto', 'acVerticalAlignmentBaseline',
    'acPrinterAlwaysAlert', 'acLong', 'acAttachmentMiddleOfBottom',
    'ac1_128in_1ft', 'acVertRight', 'acLsPlotStyle',
    'AcPointCloudStylizationType', 'acAlignmentBottomCenter',
    'AcadLayerStateManager', 'acDataRowAlignment', 'acDegrees',
    'acDataHorzTopVisibility', 'AcMenuGroupType', 'acDimLDecimal',
    'acHeaderHorzTopLineWeight', 'IAcadObjectEvents',
    'acIgnoreShadows', 'acInsertUnitsFeet', 'acDegrees30',
    'AcProxyImage', 'AcDrawingDirection', 'acDimPrecisionSeven',
    'acMoveTextNoLeader', 'acInsertAngle', 'ac90degrees', 'ac3dSolid',
    'AcadSubEntSolidEdge', 'AcRotationAngle', 'acInsertUnitsUnitless',
    'acPenWidth018', 'acIntensityRainbow', 'acVp1_4in_1ft',
    'acInches', 'AcadPaperSpace', 'IAcadDatabase',
    'acContentProperties', 'acVp3in_1ft', 'acTolerance',
    'acDimPrecisionTwo', 'acPoint2d', 'acEdRepeatLastCommand',
    'AcPredefBlockType', 'acZero', 'AcDimLUnits',
    'acKeyboardRunningObjSnap', 'acPaletteBySession', 'ac4_1',
    'IAcadMLine', 'acDataRow', 'acTitleHorzTopColor',
    'acLsLineWeight', 'IAcadIdPair', 'acTitleVertLeftVisibility',
    'AcDimUnits', 'acLineSpacingStyleExactly',
    'acAttachmentLinedCenter', 'acPViewport',
    'acCellStateContentModified', 'acArrowOpen30',
    'AcPlotPolicyForNewDwgs', 'acTableFlowRight', 'ac2018_Template',
    'acRepeatLastCommand', 'acNormals', 'acCenterNone',
    'acUpdateOptionIncludeXrefs', 'acBlockReference',
    'acCellBottomVisibility', 'AcadBlockReference', 'acR18_dwg',
    'acHeaderHorzBottomVisibility', 'acMiddleLeft', 'acTrace',
    'AcadRasterImage', 'acCellStateNone', 'AcHatchStyle',
    'acHeaderRowColor', 'AcadSolid', 'AcadGroups', 'AcMeshCreaseType',
    'acDataType', 'acInsertUnitsAutoAssign', 'acStraightLeader',
    'acObjectColor', 'acAlignmentCenter', 'acVertCellMargin',
    'AcPatternType', 'acDimRadialLarge', 'acAlignmentMiddleLeft',
    'acCellBackgroundColor', 'IAcadPolygonMesh',
    'acToolbarDockBottom', 'acIntensityBlue', 'ac10_1',
    'acPartialMenuGroup', 'acWindow', 'AcTableDirection',
    'acForExpression', 'IAcadSweptSurface', 'acTableFlowDownOrUp',
    'acDimLScientific', 'AcDimVerticalJustification', 'acCircle',
    'acMarginBottom', 'acTurns', 'acCellRightGridColor', 'ACAD_POINT',
    'acMInsertBlock', 'ACAD_LWEIGHT', 'acHatchLoopTypeDerived',
    'acTopToBottom', 'AcKeyboardPriority', 'AcPolylineType',
    'acFlowDirection', 'acTitleRow',
    'ACADSECURITYPARAMS_ENCRYPT_PROPS', 'acShadePlotHidden',
    'acCenterLine', 'acVp1_5', 'acHeaderVertInsideVisibility',
    'IAcadUCS', 'acAlignmentAligned', 'acFractional', 'acMagenta',
    'IAcadSubDMeshVertex', 'acPoint', 'IAcadAttributeReference',
    'acExtendThisEntity', 'acCellStateContentLocked', 'acAttribute',
    'IAcadDimStyle', 'acMenuFileCompiled', 'AcSectionSubItem',
    'acArrowOpen90', 'AcadNurbSurface', 'AcDimArrowheadType',
    'AcadTableStyle', 'acAlignmentTopRight',
    'acDataVertLeftLineWeight', 'acVp10_1', 'acCW', 'acUnknownCell',
    'acMetric', 'acDataRowFillColor', 'AcadHyperlink',
    'acTitleRowTextHeight', 'IAcadPViewport', 'acTableSelectWindow',
    'AcVerticalAlignment', 'AcPlotOrientation', 'acEnableSCM',
    'acDimPrecisionZero', 'acLineWithArrow', 'acHatchStyleNormal',
    'IAcadSectionSettings', 'acViewport4',
    'acTitleVertLeftLineWeight', 'acTitleHorzTopLineWeight',
    'acVpCustomScale', 'AcMeasurementUnits', 'acArrowArchTick',
    'acSelectionSetCrossingPolygon', 'acHeaderVertRightLineWeight',
    'acRightToLeft', 'acDegrees60', 'ac3dFace', 'acTrueColor',
    'acNurbSurface', 'IAcadTextStyle', 'acToolbarDockTop', 'acTable',
    'acHatchStyleIgnore', 'acSubtraction', 'acUserDefinedGradient',
    'acSplineWithArrow', 'AcDrawingAreaSCMCommand', 'IAcadSurface',
    'AcViewportSplitType', 'acApplied', 'acLnWt009',
    'acEnableSCMOptions', 'AcadIdPair', 'acPaletteByDrawing',
    'acHeaderRow', 'AcadLayers', 'AcadOle', 'acNoOverrides',
    'AcadComparedReference', 'acPenWidth140', 'acAlignmentBottomLeft',
    'acColorMethodByLayer', 'acDragDoNotDisplay', 'acEnglish',
    'acIntensityGreen', 'acTextHeight', 'AcShadowDisplayType',
    'acVp1_2', 'IAcadHyperlink', 'acCellContentTypeBlock', 'acLsOn',
    'IAcadRegion', 'AcCellContentLayout', 'AcadMInsertBlock',
    'acInsertUnitsMicroinches', 'acTitleVertRightLineWeight',
    'acInsertUnitsAngstroms', 'ac2013_Template', 'acView',
    'AcPointCloudExStylizationType', 'acVp1_20', 'IAcadDimArcLength',
    'acR15_dwg', 'AcDrawLeaderOrderType', 'acConnectBase',
    'IAcadView', 'acPenWidth013', 'acLastNormal', 'IAcadXline',
    'acPolicyNamed', 'AcDataLinkUpdateOption', 'AcCellEdgeMask',
    'acForEditing', 'acTitleRowColor', 'acBuffer', 'IAcadLWPolyline',
    'ACADSECURITYPARAMS_ENCRYPT_DATA', 'acHorzBottom',
    'acPolyfaceMesh', 'AcadSectionManager', 'acCellMarginHorzSpacing',
    'AcadPlaneSurface', 'acYellow', 'acAttachmentPointMiddleRight',
    'acNoneContent', 'AcadDictionaries', 'acDemandLoadEnabled',
    'AcDimHorizontalJustification', 'AcBlockConnectionType',
    'AcadViewports', 'acResbuf', 'ac1_30', 'acDate',
    'acUpdateOptionNone', 'ac1_8', 'AcadSectionSettings',
    'IAcadDimension', 'IAcadExtrudedSurface',
    'acDataHorzBottomVisibility', 'IAcadUCSs',
    'AcadDynamicBlockReferenceProperty', 'acInsertUnitsDecimeters',
    'AcadCircle', 'AcadPointCloud', 'acMTextContent', 'ac1_32in_1ft',
    'acPolylineLight', 'acCellLeftVisibility',
    'acHeaderHorzBottomColor', 'AcadBlocks', 'IAcadHatch',
    'acUnitless', 'ac2004_dwg', 'acArrowOrigin2', 'acTopCenter',
    'acCellMarginTop', 'acAlwaysCrease', 'ACAD_NOUNITS',
    'acMarginTop', 'ac1_16in_1ft', 'AcadMLeader', 'acLnWt200',
    'acSectionSubItemSectionLineTop', 'acClassification',
    'AcAttributeMode', 'acPreDefinedGradient', 'acPenWidth100',
    'AcadPlotConfiguration', 'acSectionSubItemkNone', 'acPenWidth070',
    'acTitleHorzBottomVisibility', 'AcSplineFrameType',
    'acCastsShadows', 'acCellContentLayoutStackedVertical',
    'AcadLayouts', 'ac1in_1ft', 'acMergeAll', 'acActiveViewport',
    'AcSectionState2', 'acPlotOrientationLandscape', 'AcFormatOption',
    'acLeftMask', 'AcMLineJustification', 'AcOlePlotQuality',
    'AcadLayout', 'IAcadObject', 'acDimPrecisionFive',
    'IAcadExternalReference', 'AcadDimDiametric',
    'acTitleRowFillColor', 'ac2_1', 'AcadExtrudedSurface',
    'acAlignmentLeft', 'AcDynamicBlockReferencePropertyUnitsType',
    'acTitleVertLeftColor', 'AcOnOff', 'ac2004_Template',
    'acCellTopGridColor', 'acLnWt050', 'AcToolbarDockStatus',
    'acOQPhoto', 'acLnWt018', 'IAcadSectionManager', 'acLock',
    'acSelectionSetLast', 'acCellMarginRight',
    'acAttachmentMiddleOfTop', 'acColorMethodByACI',
    'AcadSortentsTable', 'AcadSweptSurface', 'acHide', 'IAcadBlock',
    'ac0degrees', 'AcadDimAngular', 'acNorm', 'AcSaveAsType',
    'acGridLineStyleSingle', 'acCellBottomGridLineWeight',
    'ac6in_1ft', 'acOQText', 'acAttachmentBottomOfTop',
    'AcadSecurityParamsConstants', 'acPolicyLegacyQuery',
    'AcAttachmentPoint', 'IAcadCircle', 'acDataTypeAndFormat',
    'ac1_4in_1ft', 'acViewport3Right', 'acInsertUnitsMillimeters',
    'acLeftAlignment', 'IAcadMLeaderStyle', 'acPolicyLegacyLegacy',
    'acHatchLoopTypePolyline', 'acVp1_16in_1ft', 'ac1ft_1ft',
    'AcadLayer', 'AcadSurface', 'acEnter', 'acHeight',
    'AcDrawingAreaSCMEdit', 'ac1_8in_1ft', 'acCenterMark',
    'AcDimToleranceMethod', 'IAcad3DFace', 'acHeaderRowTextStyle',
    'ac2010_dwg', 'acDataHorzTopColor', 'acMax',
    'acSelectionSetFence', 'acDegrees000', 'IAcadPaperSpace',
    'acMoveTextAddLeader',
    'acUpdateOptionOverwriteContentModifiedAfterUpdate',
    'acHorizontalAlignmentCenter', 'IAcadLayouts', 'acSmooth',
    'AcadSubEntSolidFace', 'acZoomScaledRelative',
    'acTitleHorzBottomLineWeight', 'acShadePlotWireframe',
    'AcadModelSpace', 'IAcadXRecord', 'acGreen', 'acMarginLeft',
    'acIntensity', 'acMergeCellStyleIgnoreNewStyles',
    'acAttributeModeNormal', 'acSectionState2Plane',
    'IAcadRevolvedSurface', 'AcOleQuality', 'acVp1_1',
    'AcTextGenerationFlag', 'acOCS', 'acTitleVertInsideVisibility',
    'AcadRegisteredApplication', 'ac270degrees',
    'acSectionSubItemSectionLineBottom', 'IAcad3DSolid',
    'AcadAttributeReference', 'acDimFractional', 'acVp1_16',
    'acPixels', 'AcTextAttachmentDirection', 'acUniformParam',
    'IAcadTable', 'acDimRadial', 'acDimWindowsDesktop',
    'acCellMarginVertSpacing', 'acDimScientific', 'IAcadHyperlinks',
    'acTextFlagUpsideDown', 'acArrowsOnly',
    'acAttachmentPointMiddleCenter', 'AcadBlock', 'AcadMaterial',
    'acDegrees15', 'acOverSecondExtension', 'acDimPrecisionFour',
    'acTitleVertInsideColor', 'IAcadAttribute', 'acHorzTop',
    'acInsertUnitsMicrons', 'AcadUCS', 'IAcadDimOrdinate',
    'acBottomMask', 'acDegreesHorz', 'acAttachmentPointTopCenter',
    'acDim3PointAngular', 'AcCellState', 'acHorizontalAlignmentFit',
    'acOn', 'acCellBackgroundFillNone', 'acScanColor',
    'acHeaderVertInsideLineWeight', 'acAttributeModeMultipleLine',
    'acIntensityRed', 'acVp3_4in_1ft', 'acDegrees090',
    'acAlignmentFit', 'acOQLineArt', 'IAcadModelSpace',
    'AcDimArcLengthSymbol', 'acTrue', 'AcTableStyleOverrides',
    'AcBlockScaling', 'AcadPoint', 'acAttachmentPointMiddleLeft',
    'IAcadDictionaries', 'AcadArc', 'acArrowBoxFilled',
    'acSectionState2Slice', 'acArrowDotBlank', 'AcPlotRotation',
    'acSectionStateVolume', 'acR15_dxf', 'IAcadMLeader', 'acAny',
    'AcDrawingAreaShortCutMenu', 'IAcadSubEntity', 'ACAD_ANGLE',
    'acCellMarginBottom', 'AcadSummaryInfo', 'acHatchLoopTypeDefault',
    'AcSelectType', 'AcDimFractionType', 'ac1_100', 'acVp1_40',
    'acUnitDistance', 'AcTableFlowDirection', 'acTextAndArrows',
    'acDimLWindowsDesktop', 'acDataHorzTopLineWeight',
    'acCellTopGridLineWeight', 'acDataRowFillNone',
    'acHeaderVertLeftVisibility', 'acIntensityEditableFlag',
    'acArrowClosed', 'acAttachmentPointTopLeft',
    'acDataRowTextHeight', 'acControlVertices', 'ACAD_LTYPE',
    'IAcadPlaneSurface', 'acVertInside', 'AcOleType',
    'acPartialPreview', 'AcWindowState', 'acNormal', 'acVp1_64in_1ft',
    'acArrowSmall', 'AcDrawingAreaSCMDefault',
    'acInsertUnitsAstronomicalUnits', 'acSimple3DPoly', 'acUnion',
    'acExtendBoth', 'AcadTolerance', 'acHorzCentered',
    'AcTextAngleType', 'acVp3_16in_1ft', 'acToolbarSeparator',
    'acOPQLowGraphics', 'acAttributeModeVerify', 'acScaleToFit',
    'acLineNoArrow', 'AcActiveSpace', 'acVertCentered',
    'acDwfUnderlay', 'IAcadMaterial', 'AcPlotPolicyForLegacyDwgs',
    'acFlowDirBtoT', 'acBaseMenuGroup', 'AcadDimOrdinate',
    'AcPrinterSpoolAlert', 'acCubicSpline3DPoly', 'acEndsNormal',
    'IAcadTableStyle', 'AcadDimRotated', 'acEllipse',
    'acSetDefaultFormat', 'acLnWt030', 'acNoneCrease',
    'acAttachmentBottomOfBottom', 'acDemandLoadEnabledWithCopy',
    'IAcadViews', 'acVp1_32in_1ft', 'acAlignmentBottomRight',
    'acInsertUnitsUSSurveyFeet', 'acPolymesh', 'acVp100_1',
    'AcadExternalReference', 'acDimPrecisionOne', 'acUnknownRow',
    'acLimits', 'acDemandLoadDisabled', 'acReceivesShadows',
    'acSectionSubItemBackLineTop', 'acFit', 'AcadMaterials',
    'acMarginRight', 'AcInsertUnits', 'IAcadShadowDisplay', 'acHatch',
    'acSolid', 'IAcadText', 'AcLineWeight', 'Acad3DSolid',
    'acBlockTriangle', 'AcDimCenterType', 'AcCellMargin',
    'acCellStateContentReadOnly', 'AcCoordinateSystem',
    'IAcadSectionTypeSettings', 'IAxDbDocumentEvents',
    'acViewport3Below', 'ac1_2in_1ft', 'AcSplineMethodType',
    'acProxyBoundingBox', 'acExternalReference', 'IAcadRasterImage',
    'acDrawLeaderTailFirst', 'acToolbarDockLeft',
    'acCellStateFormatModified', 'acSimplePoly', 'acLnWt070',
    'acAngular', 'acHatchLoopTypeExternal', 'acBlockBox',
    'acAutoScale', 'acJIS', 'acVerticalAlignmentTop', 'IAcadRay',
    'acArrowOblique', 'acTableSelectCrossing', 'acLnWt100',
    'acRightMask', 'AcadViewport', 'AcMenuItemType',
    'acHeaderSuppressed', 'acDimLineWithText',
    'IAcadSectionTypeSettings2', 'acTop', 'AcadUCSs',
    'acCellDataType', 'acShadePlotRendered', 'acPolicyNewDefault',
    'AcadEntity', 'acHorizontalAlignmentRight', 'acHatchStyleOuter',
    'ac2000_Template', 'acDouble', 'acHatchPatternTypeUserDefined',
    'IAcadDimDiametric', 'acSpline', 'AcUnderlayLayerOverrideType',
    'acVp1ft_1ft', 'acHorizontal', 'ac8_1', 'AcadLeader',
    'acInsertUnitsUSSurveyInch', 'acDimLArchitectural', 'acByBlock',
    'acShadePlotAsDisplayed', 'acIsolines', 'acContentColor',
    'acTopMask', 'AcHelixConstrainType', 'acPolicyNewLegacy',
    'acArrowIntegral', 'acAlignmentMiddle', 'acTurnHeight',
    'acPdfUnderlay', 'acDrawContentFirst',
    'AcAlignmentPointAcquisition', 'acMtext', 'acPreserveMtextFormat',
    'AcSectionGeneration', 'AcMLeaderContentType', 'acAllViewports',
    'acArrowOpen', 'AcCellType', 'AcLoftedSurfaceNormalType',
    'acOPQHighGraphics', 'acViewport3Left', 'acDimPrecisionEight',
    'AcadDimRadialLarge', 'acCellContentTypeUnknown',
    'IAcadLayerStateManager', 'acElevation', 'acFirstNormal',
    'IAcadLine', 'IAcadOle', 'acLnWt106', 'AcadRay',
    'AcadRevolvedSurface', 'acSectionSubItemSectionLine',
    'ACADSECURITYPARAMS_SIGN_DATA', 'acArea',
    'acUpdateOptionOverwriteFormatModifiedAfterUpdate',
    'acTitleRowDataType', 'acAttributeModePreset', 'acArchitectural',
    'acLsPlot', 'acBezierSurfaceMesh', 'acGrads', 'IAcadTrace',
    'acDataHorzInsideVisibility', 'ac2013_dxf', 'acBlockContent',
    'acCellLeftGridLineWeight', 'acBlockImperial', 'acLnWtByBlock',
    'acR14_dxf', 'acHeaderHorzBottomLineWeight', 'acDimAngular',
    'acHeaderRowFillNone', 'AcadRegisteredApplications',
    'acAlignPntAcquisitionAutomatic', 'AcadView',
    'acInsertUnitsMeters', 'acR13_dwg', 'acDimLEngineering',
    'acInsertUnitsLightYears', 'acR18_Template', 'acBottomRight',
    'AcMenuFileType', 'IAcadDimAngular', 'AcadPolyline', 'acVp2_1',
    'acLnWt015', 'acToolbarFloating', 'acWhite',
    'acHeaderVertRightVisibility', 'acUnitVolume', 'AcadSubDMesh',
    'acTolTop', 'acCellContentColor', 'acInsertUnitsYards',
    'acMergeCellStyleOverwriteDuplicates',
    'acUpdateOptionUpdateFullSourceRange', 'acArrowUserDefined',
    'acLineSpacingStyleAtLeast', 'acLsFrozen', 'acMergeCellStyleNone',
    'acCellContentLayoutFlow', 'AcadSubDMeshVertex', 'acDegreesAny',
    'acOTLink', 'ac3dPolyline', 'acZoomScaledRelativePSpace',
    'AcHorizontalAlignment', 'AcadTextStyles', 'AcInsertUnitsAction',
    'acVp8_1', 'AcUnits', 'IAcadEntity', 'AcadObject',
    'acArrowDatumBlank', 'IAcadLayers', 'acHeaderHorzTopVisibility',
    'acLnWt158', 'IAcadPlotConfiguration',
    'acSectionGenerationDestinationFile', 'acVp1_8in_1ft',
    'acDataVertRightVisibility', 'IAcadDatabasePreferences',
    'acBlockCircle', 'acPenWidth025', 'ac1_20',
    'acFirstExtensionLine', 'AcPointCloudIntensityStyle',
    'AcadDwfUnderlay', 'ac1_1', 'acTitleSuppressed', 'acBlockCell',
    'acLeader', 'acFitCurvePoly', 'AcadXRecord',
    'AcadSecurityParamsType', 'acSectionSubItemVerticalLineBottom',
    'acBestFit', 'AcPolymeshType', 'acArc',
    'IAcadRegisteredApplications', 'acMergeCellStyleCopyDuplicates',
    'acCastsAndReceivesShadows', 'acR13_dxf', 'IAcadSection',
    'acUpdateDataFromSource', 'acSelectionSetCrossing',
    'AcadPlotConfigurations', 'AcadXline', 'acFullPreview',
    'acSelectionSetAll', 'AcTextAlignmentType',
    'acCellRightVisibility', 'acDataVertRightLineWeight',
    'AcToolbarItemType', 'AcDragDisplayMode', 'IAcadMText', 'acMLine',
    'acVp1_8', 'acHorzCellMargin', 'acLnWt035', 'ACAD_DISTANCE',
    'AcadShape', 'acDrawLeaderFirst', 'IAcadTolerance', 'ac2000_dxf',
    'acUseDraftAngles', 'acGroup', 'ac1_40', 'acDataHorzBottomColor',
    'acBlockUserDefined', 'acCellRightGridLineWeight',
    'acTolSymmetrical', 'acHorzInside', 'acLnWt211', 'AcadText',
    'acBottomToTop', 'ac3_8in_1ft', 'acDimPrecisionThree',
    'acInVisibleLeader', 'AcadGeoPositionMarker', 'AcadLineTypes',
    'AcHelixTwistType', 'acRegion', 'IAcadSubDMeshEdge',
    'acBottomLeft', 'acAlignmentMiddleCenter', 'acText', 'AcDimFit',
    'IAcadSummaryInfo', 'acVerticalAlignmentBottom', 'acRay',
    'AcadDgnUnderlay', 'AcadSubDMeshFace', 'acInsertUnitsDecameters',
    'IAcadDimAligned', 'AcDataLinkUpdateDirection', 'acVp1_30',
    'IAcadDynamicBlockReferenceProperty', 'acSectionState2Volume',
    'AcParseOption', 'IAcadWipeout', 'acUseMaximumPrecision',
    'acDataVertRightColor', 'acOff', 'acLnWt040',
    'acHeaderHorzInsideLineWeight', 'AcadAttribute',
    'acAllCellProperties', 'AcRegenType', 'IAcadSubDMesh',
    'AcKeyboardAccelerator', 'IAcadSolid', 'IAcadLayer', 'AcadTrace',
    'acDegrees90', 'AcWireframeType', 'ACADSECURITYPARAMS_ALGID_RC4',
    'IAcadDimRotated', 'AcValueUnitType', 'acUnitAngle', 'acBlue',
    'acByLayer', 'acTolDeviation', 'AcadMLeaderStyle',
    'acTextFlagBackward', 'acModelSpace', 'acCreaseByLevel',
    'IAcadDwfUnderlay', 'acParseOptionNone', 'AcLineSpacingStyle',
    'acDataRowColor', 'acViewport3Vertical', 'IAcadPolyfaceMesh',
    'acObjectId', 'acExtents', 'AcadHyperlinks', 'acFalse',
    'acObject', 'acIntensities', 'acDecimal', 'acViewport3Horizontal',
    'acTolMiddle', 'acProxyShow', 'acDataVertLeftVisibility',
    'AcEntityName', 'acQuadSpline3DPoly', 'AcadPdfUnderlay',
    'acCellStateFormatReadOnly', 'acVp3_8in_1ft', 'IAcadAcCmColor',
    'acSectionSubItemVerticalLineTop', 'acTextOnly', 'acCellAlign',
    'acTitleHorzInsideColor', 'ac1_4', 'acVp1_100', 'AcadPViewport',
    'acTitleVertRightColor', 'acViewport2Horizontal', 'AcadMLine',
    'acBlockSlot', 'AxDbDocument', 'acNative', 'acPenWidth200',
    'acFontBoldItalic', 'acDataFormat', 'ac2013_dwg',
    'acAttachmentBottomLine', 'IAcadGroups', 'acInsertUnitsInches',
    'AcPlotPaperUnits', 'acPoint3d', 'acBottom', 'acArrowDot',
    'acQuadSplinePoly', 'acTitleHorzBottomColor',
    'acAttachmentPointBottomCenter', 'IAcadBlocks', 'AcColorMethod',
    'IAcadMInsertBlock', 'acUCS', 'IAcadLineType', 'IAcadMaterials',
    'acDegrees180', 'acDimRotated', 'acTopLeft', 'AcadMLeaderLeader',
    'AcadGroup', 'AcLoopType', 'IAcad3DPolyline',
    'acSectionType3dSection', 'AcHatchObjectType',
    'acInsertUnitsNanometers', 'acIsoparms', 'AcValueDataType',
    'acLnWt090', 'IAcadMLeaderLeader', 'Acad3DFace',
    'acUnknownDataType', 'acTitleHorzInsideVisibility', 'acVp6in_1ft',
    'acRed', 'IAcadGeoPositionMarker', 'acArrowOrigin',
    'acOTEmbedded', 'acHeaderHorzTopColor', 'acSectionType2dSection',
    'kFormatOptionNone', 'acAlignmentMiddleRight',
    'acColorMethodByRGB', 'acIntersection', 'AcadWipeout',
    'acOTStatic', 'acTableBottomToTop', 'IAcadDimRadialLarge',
    'acCustomParameterization', 'acLsNewViewport', 'acCellTextStyle',
    'AcadSecurityParams', 'acRightAlignment',
    'acAttachmentHorizontal', 'acChord', 'acDataVertInsideColor',
    'acDegreesUnknown', 'acHeaderVertLeftLineWeight',
    'acViewport2Vertical', 'acSymAbove',
    'acAttachmentPointBottomLeft', 'acAttributeModeConstant',
    'acDimEngineering', 'acAttachmentAllLine', 'AcadHelix',
    'ACADSECURITYPARAMS_ADD_TIMESTAMP', 'acLnWt020',
    'IAcadSubEntSolidEdge', 'AcadMText', 'acMenuItem', 'acFontBold',
    'acIgnoreMtextFormat', 'acRadians', 'IAcadTextStyles',
    'acVertLeft', 'IAcadLoftedSurface',
    'acHatchPatternTypeCustomDefined', 'ac1_64in_1ft',
    'acCellTopVisibility', 'IAcadPoint', 'acLnWt060',
    'acAttachmentCenter', 'IAcadSubEntSolidVertex', 'AcRowType',
    'acRGB', 'acVp1and1_2in_1ft', 'acTitleVertRightVisibility',
    'acDataHorzInsideColor', 'acPrinterNeverAlertLogOnce', 'acScale',
    'acArrowDatumFilled', 'acDataHorzInsideLineWeight',
    'acMenuFileSource', 'ac3_32in_1ft', 'acR15_Template', 'acLnWt053',
    'AcadDimStyle', 'acSelectionSetPrevious', 'acVp1_50',
    'AcDimPrecision', 'acSectionTypeLiveSection', 'acDefaultUnits',
    'acDragDisplayAutomatically', 'acUnitArea', 'acMenuSubMenu',
    'AcZoomScaleType', 'acAlignmentTopCenter', 'acViewport3Above',
    'AcAngleUnits', 'acHeaderRowFillColor',
    'acAttributeModeLockPosition',
    'acCellContentLayoutStackedHorizontal', 'AcadDictionary',
    'acScientific', 'acPrinterNeverAlert', 'acToolbarDockRight',
    'acHorizontalAlignmentAligned', 'acSectionStateBoundary',
    'acDimLFractional', 'acInsertUnitsUSSurveyMile', 'acArrowNone',
    'acAlignPntAcquisitionShiftToAcquire', 'acUnknown', 'acTopRight',
    'acLsNone', 'AcBooleanType', 'acCellMarginLeft',
    'acTitleRowAlignment', 'AcadSection', 'acInsertUnitsPrompt',
    'acProxyNotShow', 'acString', 'AcadDimRadial',
    'acColorMethodByBlock', 'IAcadGeomapImage', 'AcPreviewMode',
    'ac2010_dxf', 'acVp1_2in_1ft', 'ac180degrees', 'acOQGraphics',
    'acCellBottomGridColor', 'acSymInFront', 'AcSegmentAngleType',
    'acTitleHorzTopVisibility', 'ACAD_COLOR', 'acVp3_32in_1ft',
    'acDemandLoadOnObjectDetect', 'acLnWt120', 'AcadTable',
    'acHatchObject', 'acFontItalic', 'IAcadSortentsTable',
    'acMergeCellStyleConvertDuplicatesToOverrides',
    'acInsertUnitsKilometers', 'ac2000_dwg', 'IAcadViewports',
    'acDimDecimal', 'acVp1in_1ft', 'AcadTextStyle', 'acPenWidthUnk',
    'acToolbarControl', 'acAttachmentTopOfTop', 'AcadLWPolyline',
    'acHeaderVertInsideColor', 'AcCellContentType', 'AcadEllipse',
    'acKeyboardEntryExceptScripts', 'AcadLine', 'AcAlignment',
    'IAcadSection2', 'ac1_16', 'IAcadDimRadial', 'acBlockHexagon',
    'AcadDatabasePreferences', 'IAcadSecurityParams',
    'acBottomCenter', 'acLnWtByLayer', 'acAttributeReference',
    'AcGridLineStyle', 'acArrowDotSmall', 'IAcadNurbSurface',
    'acLsColor', 'acEnableBackgroundColor', 'acDistance',
    'acHeaderVertRightColor', 'acEngineering', 'AcViewportScale',
    'acXline', 'acAttachmentPointTopRight', 'acOverFirstExtension',
    'AcGridLineType', 'acShape', 'acArrowDefault',
    'acHorizontalAlignmentLeft', 'acDrawLeaderHeadFirst',
    'IAcadDim3PointAngular', 'IAcadHelix', 'acVp1_4',
    'acDemanLoadDisable', 'acHatchPatternTypePreDefined',
    'kCellOptionNone', 'ac2004_dxf', 'acByColor', 'acOPQMonochrome',
    'acPaperSpace', 'acTitleRowTextStyle', 'acArrowClosedBlank',
    'IAcadPointCloudEx2', 'acLnWt005',
    'acSectionGenerationSourceSelectedObjects', 'AcadViews',
    'IAcadPointCloudEx', 'acDimAligned', 'acColorMethodForeground',
    'acSectionGenerationDestinationReplaceBlock', 'ac2010_Template',
    'IAcadArc', 'acLnWt080', 'acLnWt025', 'AcMLeaderType',
    'acBackgroundColor', 'acToolbarFlyout', 'acGradientObject',
    'acSplineNoArrow', 'acPenWidth035', 'ACAD_NULL',
    'IAcadPointCloud', 'AcadDimAligned', 'acSCM', 'acSimpleMesh',
    'acAlignmentProperty', 'AcadSubEntSolidNode',
    'acVerticalAlignmentMiddle', 'acHeaderRowTextHeight',
    'ac2007_Template', 'acDegreeMinuteSeconds',
    'acHeaderHorzInsideColor', 'AcadPolyfaceMesh', 'acDiagonal',
    'AcadGeomapImage', 'acMiddleRight', 'acPaperSpaceDCS',
    'acSectionState2Boundary', 'acShow', 'kInheritCellFormat',
    'acAttachmentMiddle', 'acAbove', 'AcPointCloudColorType',
    'acByStyle', 'AcPlotType', 'acInvalidGridLine',
    'acInsertUnitsCentimeters', 'acNoUnits',
    'acSectionSubItemBackLineBottom', 'acExtendOtherEntity',
    'acDimArcLength', 'acDegrees45', 'acHeaderVertLeftColor',
    'acUpdateSourceFromData', 'acExtendNone', 'acInsertUnitsMiles',
    'AcColor', 'ac100_1', 'acAllNormal', 'AcadAcCmColor',
    'acCellStateLinked', 'acPolicyLegacy', 'acLsAll',
    'AcCellAlignment', 'acTolBasic', 'acNotStacked',
    'acCellContentTypeValue', 'AcadDatabase', 'acLsLocked',
    'acSplineLeader', 'acR14_dwg', 'IAcadLayout', 'ac2018_dxf',
    'IAcadDimStyles', 'acContentLayout', 'AcadDim3PointAngular',
    'AcadDimArcLength', 'AcTextFontStyle',
    'acUseDefaultDrawingAreaShortCutMenu', 'acPolyline',
    'acAlignmentRight', 'acVp1_128in_1ft', 'acInsertUnitsGigameters',
    'acLnWt140', 'acIntensityGrayscale', 'acEdSCM', 'acSubDMesh',
    'AcSectionState', 'AcBoolean', 'acVp1_10', 'acUnder',
    'AcShadePlot', 'acDataRowDataType', 'acMiddleCenter',
    'AcPlotScale', 'acTableTopToBottom', 'acLine', 'acTolNone',
    'acCellStateFormatLocked', 'acSecondExtensionLine', 'acLayout',
    'acTextStyle', 'acDragDisplayOnRequest', 'IAcadComparedReference',
    'IAcadViewport', 'AcXRefDemandLoad',
    'acHeaderHorzInsideVisibility', 'acPrinterAlertOnce',
    'acBitProperties', 'acR18_dxf', 'acPenWidth050', 'acSymNone',
    'acCubicSplinePoly', 'AcGradientPatternType', 'acVp4_1',
    'acDegrees270', 'acCyan', 'AcadLineType',
    'acNoDrawingAreaShortCutMenu', 'acDisplayDCS', 'acRuled',
    'ac1_10', 'acLnWt013', 'IAcadBlockReference', 'acMLeader',
    'acPolicyLegacyDefault', 'AcadPolygonMesh', 'acDataVertLeftColor',
    'AcadSpline', 'acDisplay', 'AcLayerStateMask',
    'AcDimToleranceJustify', 'acDimArchitectural', 'acDgnUnderlay',
    'acInsertUnitsUSSurveyYard', 'acDimPrecisionSix',
    'acInvalidCellProperty', 'Acad3DPolyline', 'acTolLimits',
    'acQuadSurfaceMesh', 'acR12_dxf', 'acArrowBoxBlank',
    'acPlotOrientationPortrait', 'ac3in_1ft',
    'AcVerticalTextAttachmentType', 'AcadPointCloudEx',
    'acLnWtByLwDefault', 'acTitleHorzInsideLineWeight', 'ac1_50',
    'ac3_4in_1ft', 'AcadSectionTypeSettings', 'IAcadUnderlay',
    'acSelectionSetWindow', 'AcSplineKnotParameterizationType',
    'acFontRegular', 'acTextCell', 'acCellTextHeight',
    'acDataRowTextStyle', 'acHorizontalAlignmentMiddle',
    'acCubicSurfaceMesh', 'IAcadLeader', 'AcadRegion', 'AcPlotPolicy',
    'acTitleVertInsideLineWeight', 'IAcadShape', 'IAcadLineTypes',
    'acKeyboardEntry', 'acDemandLoadCmdInvoke',
    'IAcadRegisteredApplication', 'acCCW',
    'acSectionGenerationDestinationNewBlock', 'acDimOrdinate',
    'acInsertUnitsHectometers', 'acAttachmentVertical', 'ac2018_dwg',
    'acDimFractionalStacked', 'acSectionSubItemBackLine',
    'acHorizontalAngle', 'acDataVertInsideVisibility', 'acSqrtChord',
    'acLnWt000', 'acToolbarButton', 'IAcadPolyline', 'ac3_16in_1ft',
    'AcTextAttachmentType', 'acZoomScaledAbsolute', 'AcCellProperty',
    'acCellContentTypeField', 'AcadSubEntity', 'IAcadSubDMeshFace',
    'AcadSubEntSolidVertex', 'acAttachmentBottomOfTopLine', 'acWorld',
    'acCenterAlignment', 'acVpScaleToFit', 'AcadSubDMeshEdge',
    'AcISOPenWidth', 'acMin', 'AcadHatch',
    'acAttachmentPointBottomRight', 'AcARXDemandLoad'
]

_check_version('1.1.14', 1589389616.000000)
